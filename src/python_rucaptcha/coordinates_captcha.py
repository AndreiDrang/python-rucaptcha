...
from .core.enums import SaveFormatsEnm, CoordinatesCaptchaEnm


class CoordinatesCaptcha(BaseCaptcha):
    def __init__(
        self,
        ...
        **kwargs,
        ...
        Examples:
            >>> CoordinatesCaptcha(rucaptcha_key="aa9011f31111181111168611f1151122",
            ...
            >>> await CoordinatesCaptcha(rucaptcha_key="aa9011f31111181111168611f1151122",
            ...
            >>> CoordinatesCaptcha(rucaptcha_key="some_username:some_password",
            ...
            >>> await CoordinatesCaptcha(rucaptcha_key="some_username:some_password",
            ...             service_type="deathbycaptcha"
            ...             ).aio_captcha_handler(captcha_link="https://rucaptcha.com/dist/web/99581b9d446a509a0a01954438a5e36a.jpg")
            {
               "errorId":0,
        ...
        Notes:
            ...
            https://rucaptcha.com/api-docs/coordinates
        """
        super().__init__(method=CoordinatesCaptchaEnm.CoordinatesTask.value, *args, **kwargs)
